...
inv_shift_rows state =
  case state of {
   Bytes16 r0c0 r0c1 r0c2 r0c3 r1c0 r1c1 r1c2 r1c3 r2c0 r2c1 r2c2 r2c3 r3c0 r3c1 r3c2
    r3c3 -> Bytes16 r0c0 r0c1 r0c2 r0c3 r1c3 r1c0 r1c1 r1c2 r2c2 r2c3 r2c0 r2c1 r3c1
    r3c2 r3c3 r3c0}
...
inv_sub_bytes state =
  case state of {
   Bytes16 r0c0 r0c1 r0c2 r0c3 r1c0 r1c1 r1c2 r1c3 r2c0 r2c1 r2c2 r2c3 r3c0 r3c1 r3c2
    r3c3 -> Bytes16 (inv_s_box r0c0) (inv_s_box r0c1) (inv_s_box r0c2) (inv_s_box r0c3)
    (inv_s_box r1c0) (inv_s_box r1c1) (inv_s_box r1c2) (inv_s_box r1c3) (inv_s_box r2c0)
    (inv_s_box r2c1) (inv_s_box r2c2) (inv_s_box r2c3) (inv_s_box r3c0) (inv_s_box r3c1)
...
inv_mix_column_transform column =
  case column of {
   Bytes4 a' b' c' d' ->
    let {
     a'' = xor_bytes (xor_bytes (xor_bytes (mul0e a') (mul0b b')) (mul0d c')) (mul09 d')}
    in
    let {
     b'' = xor_bytes (xor_bytes (xor_bytes (mul09 a') (mul0e b')) (mul0b c')) (mul0d d')}
    in
    let {
     c'' = xor_bytes (xor_bytes (xor_bytes (mul0d a') (mul09 b')) (mul0e c')) (mul0b d')}
    in
    let {
     d'' = xor_bytes (xor_bytes (xor_bytes (mul0b a') (mul0d b')) (mul09 c')) (mul0e d')}
    in
    Bytes4 a'' b'' c'' d''}
