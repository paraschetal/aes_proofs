...
table = {"2": [0x00,0x02,0x04,0x06,0x08,0x0a,0x0c,0x0e,0x10,0x12,0x14,0x16,0x18,0x1a,0x1c,0x1e,
...
for i in [2,3,9,11,13,14]:
  function += "| "+str(i)+" => "
  function += "match a with \n"
  for j in range(256):
    coq_byte = get_coq_byte(j)
    value = table[str(i)][j]
    function += "| "+coq_byte+" => "+get_coq_byte(int(str(value)))+" "
