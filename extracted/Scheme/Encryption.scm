...
(define shift_rows (lambda (state)
  (match state
     ((Bytes16 r0c0 r0c1 r0c2 r0c3 r1c0 r1c1 r1c2 r1c3 r2c0 r2c1 r2c2 r2c3 r3c0 r3c1
       r3c2 r3c3) `(Bytes16 ,r0c0 ,r0c1 ,r0c2 ,r0c3 ,r1c1 ,r1c2 ,r1c3 ,r1c0 ,r2c2 ,r2c3
       ,r2c0 ,r2c1 ,r3c3 ,r3c0 ,r3c1 ,r3c2)))))

(define sub_bytes (lambda (state)
  (match state
     ((Bytes16 r0c0 r0c1 r0c2 r0c3 r1c0 r1c1 r1c2 r1c3 r2c0 r2c1 r2c2 r2c3 r3c0 r3c1
       r3c2 r3c3) `(Bytes16 ,(s_box r0c0) ,(s_box r0c1) ,(s_box r0c2) ,(s_box r0c3)
       ,(s_box r1c0) ,(s_box r1c1) ,(s_box r1c2) ,(s_box r1c3) ,(s_box r2c0)
       ,(s_box r2c1) ,(s_box r2c2) ,(s_box r2c3) ,(s_box r3c0) ,(s_box r3c1)
       ,(s_box r3c2) ,(s_box r3c3))))))
       ...
       (let ((a~ (@ xor_bytes (@ xor_bytes (@ xor_bytes (mul02 a) (mul03 b)) c) d)))
         (let ((b~ (@ xor_bytes (@ xor_bytes (@ xor_bytes a (mul02 b)) (mul03 c)) d)))
           (let ((c~ (@ xor_bytes (@ xor_bytes (@ xor_bytes a b) (mul02 c)) (mul03 d))))
             (let ((d~
               (@ xor_bytes (@ xor_bytes (@ xor_bytes (mul03 a) b) c) (mul02 d))))
               `(Bytes4 ,a~ ,b~ ,c~ ,d~)))))))))
        ...
        (@ enc_round7 k
          (@ enc_round6 k
            (@ enc_round5 k
              (@ enc_round4 k
                (@ enc_round3 k
                  (@ enc_round2 k (@ enc_round1 k (@ add_round_key (key0 k) m)))))))))))))

(define enc_aes_cbc (lambdas (key iv message)
  (match message
     ((B0 s) `(B0 ,(@ enc_aes key (@ xor_matrices iv s))))
     ((BS s b)
       (let ((niv (@ enc_aes key (@ xor_matrices iv s))))
