...
(define inv_shift_rows (lambda (state)
  (match state
     ((Bytes16 r0c0 r0c1 r0c2 r0c3 r1c0 r1c1 r1c2 r1c3 r2c0 r2c1 r2c2 r2c3 r3c0 r3c1 r3c2 r3c3) `(Bytes16 ,r0c0 ,r0c1 ,r0c2 ,r0c3 ,r1c3
       ,r1c0 ,r1c1 ,r1c2 ,r2c2 ,r2c3 ,r2c0 ,r2c1 ,r3c1 ,r3c2 ,r3c3 ,r3c0)))))

(define inv_sub_bytes (lambda (state)
  (match state
     ((Bytes16 r0c0 r0c1 r0c2 r0c3 r1c0 r1c1 r1c2 r1c3 r2c0 r2c1 r2c2 r2c3 r3c0 r3c1 r3c2 r3c3) `(Bytes16 ,(inv_s_box r0c0)
       ,(inv_s_box r0c1) ,(inv_s_box r0c2) ,(inv_s_box r0c3) ,(inv_s_box r1c0) ,(inv_s_box r1c1) ,(inv_s_box r1c2) ,(inv_s_box r1c3)
       ,(inv_s_box r2c0) ,(inv_s_box r2c1) ,(inv_s_box r2c2) ,(inv_s_box r2c3) ,(inv_s_box r3c0) ,(inv_s_box r3c1) ,(inv_s_box r3c2)
       ,(inv_s_box r3c3))))))
...
(define mul0b (lambda (b) (@ xor_bytes b (@ xor_bytes (mul02 b) (mul02 (mul02 (mul02 b)))))))

(define mul0d (lambda (b) (@ xor_bytes b (@ xor_bytes (mul02 (mul02 b)) (mul02 (mul02 (mul02 b)))))))

(define mul0e (lambda (b) (@ xor_bytes (mul02 b) (@ xor_bytes (mul02 (mul02 b)) (mul02 (mul02 (mul02 b)))))))
       ...
       (let ((ncol0 (inv_mix_column_transform `(Bytes4 ,s00 ,s10 ,s20 ,s30))))
         (let ((ncol1 (inv_mix_column_transform `(Bytes4 ,s01 ,s11 ,s21 ,s31))))
           (let ((ncol2 (inv_mix_column_transform `(Bytes4 ,s02 ,s12 ,s22 ,s32))))
             (let ((ncol3 (inv_mix_column_transform `(Bytes4 ,s03 ,s13 ,s23 ,s33)))) (@ columns_to_matrix ncol0 ncol1 ncol2 ncol3)))))))))
...
(define dec_round1 (lambdas (k s) (inv_mix_columns (@ add_round_key (key9 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round2 (lambdas (k s) (inv_mix_columns (@ add_round_key (key8 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round3 (lambdas (k s) (inv_mix_columns (@ add_round_key (key7 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round4 (lambdas (k s) (inv_mix_columns (@ add_round_key (key6 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round5 (lambdas (k s) (inv_mix_columns (@ add_round_key (key5 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round6 (lambdas (k s) (inv_mix_columns (@ add_round_key (key4 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round7 (lambdas (k s) (inv_mix_columns (@ add_round_key (key3 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round8 (lambdas (k s) (inv_mix_columns (@ add_round_key (key2 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round9 (lambdas (k s) (inv_mix_columns (@ add_round_key (key1 k) (inv_sub_bytes (inv_shift_rows s))))))

(define dec_round10 (lambdas (k s) (@ add_round_key (key0 k) (inv_sub_bytes (inv_shift_rows s)))))
  ...
  (@ dec_round10 k
    (@ dec_round9 k
      (@ dec_round8 k
        (@ dec_round7 k
          (@ dec_round6 k
            (@ dec_round5 k (@ dec_round4 k (@ dec_round3 k (@ dec_round2 k (@ dec_round1 k (@ add_round_key (key10 k) c)))))))))))))

(define dec_aes_cbc (lambdas (key iv ciphertext)
  (match ciphertext
     ((B0 s) `(B0 ,(@ xor_matrices iv (@ dec_aes key s))))
     ((BS s b) (let ((d (@ dec_aes key s))) `(BS ,(@ xor_matrices iv d) ,(@ dec_aes_cbc key s b)))))))
